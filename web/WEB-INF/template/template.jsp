<%-- 
    Document   : index
    Created on : 02/08/2015, 2:39:41 PM
    Author     : Gus
    Links:
    JSP Tutorial: http://www.tutorialspoint.com/jsp/jsp_actions.htm 
    JDBC Tutorial:       http://www.tutorialspoint.com/jdbc/index.htm
    brief into to taglibs and good code: http://stackoverflow.com/questions/3177733/how-to-avoid-java-code-in-jsp-files
    java faces oracle:  http://docs.oracle.com/javaee/6/tutorial/doc/gjaam.html
    DB stuff http://www.javaworld.com/article/2076076/java-web-development/server-side-java--advanced-form-processing-using-jsp.html
--%>
...
<html lang="en" ng-app="appointmentApp">
    <head>
        ...
        <title>Appointment - <tiles:insertAttribute name="title" /></title>
        ...
        <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
            <header class="demo-header mdl-layout__header mdl-color--white mdl-color--grey-100 mdl-color-text--grey-600">
                <div class="mdl-layout__header-row">
                    <span class="mdl-layout-title"><tiles:insertAttribute name="title" /></span>
            ...
            <div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
                ...
                <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
                    ...
                    <a class="mdl-navigation__link" href="resource.html"><i class="mdl-color-text--blue-grey-400 material-icons">inbox</i>Manage Resources</a>
